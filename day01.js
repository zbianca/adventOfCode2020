...
Part one: Find the two entries that sum to 2020 and then multiply those two numbers together.
...
// console.log(findTwo(smallInput)); // -> 514579
// console.log(findTwo(input)); // -> 870331
console.log(findThree(input)); // -> 283025088